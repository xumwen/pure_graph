...
def parse_args(config_path):
    ...
    parser.add_argument('--eval_sample', type=int, default=1, choices=[0, 1])
    ...
    parser.add_argument('--num_parts', type=int, default=120)
    ...
    parser.add_argument('--meta_start_epoch', type=int, default=20)
    parser.add_argument('--ppo_start_epoch', type=int, default=10)
